...
// 	if (rank!=0)
// 	{
// 		sprintf(sendmsg, "Hello this is from RANK : %d\n",rank);
// 		MPI_Send(sendmsg, 50, MPI_CHAR, 0, tag, MPI_COMM_WORLD);
// 	}
// 	else
// 	{
// 		for(int i=1; i<size; i++)
// 		{
// 			MPI_Recv(recvmsg, 50, MPI_CHAR,i, tag, MPI_COMM_WORLD, &status);
// 			printf("\n %s", recvmsg);
// 		}
// 		printf("Hello from root RANK: %d", rank);
// 	}
